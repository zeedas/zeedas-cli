...
@test "changelog for develop" {
    ...
    assert_line -n 1 "::set-output name=slack::*Changelog*\n<https://github.com/zeedas/zeedas-cli/commit/8bb1d12|8bb1d12> Break single quote for replace string\n<https://github.com/zeedas/zeedas-cli/commit/0b138bb|0b138bb> Ensure error response parsing for 4xx and 5xx heartbeat response errors\n"
}
