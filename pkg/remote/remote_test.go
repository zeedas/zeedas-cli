...
func TestNewClient(t *testing.T) {
	client, err := remote.NewClient("ssh://zeedas:1234@192.168.1.2:222/home/pi/unicorn-hat/examples/ascii_pic.py")
...
func TestNewClient_Err(t *testing.T) {
	_, err := remote.NewClient("ssh://zeedas:1234@192.168.1.2:port")
	require.Error(t, err)

	assert.EqualError(t, err,
		`failed to parse remote file url: parse "ssh://zeedas:1234@192.168.1.2:port": invalid port ":port" after host`)
}
