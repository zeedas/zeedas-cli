...
const (
	...
	// which could not successfully be sent to the zeedas API.
...
// at next usages of the zeedas cli.
...
// from offline queue and send the heartbeats to zeedas API.
...
// Sync returns a function to send queued heartbeats to the zeedas API.
...
// sending to zeedas api is not possible. Transaction handling is left to the user
