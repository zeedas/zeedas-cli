...
func TestSubversion_Detect(t *testing.T) {
	...
	assert.Equal(t, project.Result{
		Project: "zeedas-cli",
		Branch:  "trunk",
		Folder:  "file:///D:/temp/SVN/zeedas-cli",
	}, result)
}
...
func setupTestSvn(t *testing.T) (fp string) {
	...
	copyDir(t, "testdata/svn", filepath.Join(tmpDir, "zeedas-cli/.svn"))
...
func setupTestSvnBranch(t *testing.T) (fp string) {
	...
	copyDir(t, "testdata/svn_branch", filepath.Join(tmpDir, "zeedas-cli/.svn"))
