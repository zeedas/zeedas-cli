...
func TestFilter_ExistingProjectFile(t *testing.T) {
	...
	tmpFile2, err := os.Create(filepath.Join(tmpDir, ".zeedas-project"))
	require.NoError(t, err)
...
func TestFilter_RemoteFileSkipsFiltering(t *testing.T) {
	...
	h.Entity = "ssh://zeedas:1234@192.168.1.1/path/to/remote/main.go"
...
func TestFilter_ErrNonExistingProjectFile(t *testing.T) {
	...
	assert.EqualError(t, err, "filter file: skipping because missing .zeedas-project file in parent path")
}
