...
func TestHeartbeat_ID(t *testing.T) {
	...
	assert.Equal(t, "1592868313.541149-file-coding-zeedas-heartbeat-/tmp/main.go-true", h.ID())
}
...
func TestPluginFromUserAgent(t *testing.T) {
	tests := map[string]struct {
		...
		"full information": {
			UserAgent: "zeedas/0.0.1 (linux-4.13.0-38-generic-x86_64) go1.15.3 testplugin/14.0.7",
			Expected:  "testplugin",
		},
		"less information": {
			UserAgent: "zeedas/0.0.1 testplugin/14.0.7",
			Expected:  "testplugin",
		},
		"minimum information": {
