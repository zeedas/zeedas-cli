...
import (
	...
	apicmd "github.com/zeedas/zeedas-cli/cmd/api"
	offlinecmd "github.com/zeedas/zeedas-cli/cmd/offline"
...
// SendHeartbeats sends a heartbeat to the zeedas api and includes additional
